...
from hello import WebServerConfig, read_web_server_config
import hello
...
def print_path_mock(monkeypatch: Any, mocker: Any) -> None:
    ...
    mocker.patch("hello.print")
    return mocker.spy(hello, "print")
...
def demos_hello_open_mock(monkeypatch: Any, mocker: Any) -> Any:
    ...
    return mocker.patch("hello.open", hello_open_mock)


def test_read_web_server_config(demos_hello_open_mock: Any) -> Any:
